...
const headerProfileHeight = +getComputedStyle(root)
  .getPropertyValue("--header-height")
    .slice(0, -2);
let filterMissionNavbars = document.getElementById("filter-mission-navbar");
if (filterMissionNavbars) {
    const filterMissionNavbarHeight = getComputedStyle(filterMissionNavbars).height;
